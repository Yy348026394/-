<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="modi.aspx.cs" Inherits="users_Edit" ValidateRequest="false" Title="" %>
...
<asp:TextBox ID="txt_lname" runat="server" width="200" Enabled="false"></asp:TextBox></div>
 </td></tr>
