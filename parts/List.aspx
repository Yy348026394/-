<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="parts_List" Title="" %>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tbody><tr>
    <td height="24" nowrap=""><font color="#FFFFFF"><img src="../Images/Explain.gif" width="18" height="18" border="0" align="absmiddle">&nbsp;<strong>科室管理</strong></font></td>
  </tr> 
</tbody></table>
<br>
  <center>
  ...
  <tbody><tr>
    <td height="24" nowrap="" bgcolor="#EBF2F9" align=center>
        ...
        <Columns>       
            ...
            <asp:HyperLinkField DataNavigateUrlFormatString="Edit.aspx?id={0}"  DataNavigateUrlFields="pid" HeaderText="编辑" Text="编辑"  >                
