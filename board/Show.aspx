<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Show.aspx.cs" Inherits="board_Show" Title="" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tbody><tr>
    <td height="24" nowrap=""><font color="#FFFFFF"><img src="../Images/Explain.gif" width="18" height="18" border="0" align="absmiddle">&nbsp;<strong>留言管理：查看留言详情</strong></font></td>
  </tr>
</tbody></table>
  <center>
    <br>
 ...
 <tr>
	<td height="25" width="20%" align="right">留言人：</td>
...
<tr>
<td  style=" text-align:right; width:20%;"><font style='color:red'>*&nbsp;</font>回复内容:</td>
<td class="tbright"><div style="display:inline;float:left;">
<asp:TextBox ID="txt_anmemo" runat="server" width="259px" Height="79px" TextMode="MultiLine"></asp:TextBox></div>
 </td></tr>
      ...
      <tr>
        ...
        <td valign="bottom"><div align="left"></div></td>
         ...
         var fanmemo = new LiveValidation('ctl00_ContentPlaceHolder1_txt_anmemo', { validMessage: '√', wait: 2000 });
        fanmemo.add(Validate.Presence, { failureMessage: "请输入回复内容！" });
</script>
</asp:Content>
