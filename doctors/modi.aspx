<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="modi.aspx.cs" Inherits="doctors_Edit" ValidateRequest="false" Title="" %>
...
<asp:TextBox ID="txt_did" runat="server" width="200" Enabled="false"></asp:TextBox></div>
 </td></tr>
...
<td class="tbright"><div style="display:inline;" class="auto-style1">
