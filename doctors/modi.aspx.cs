...
public partial class doctors_Edit : System.Web.UI.Page
{
   ...
   /// <summary>
    ...
    protected void chushi()
    {
        ...
        string strSql = string.Format("select * from doctors where  did='{0}'", Session["aid"].ToString());
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        string strSql=String.Format(@"update doctors set 
                                    dname = '{0}',sex = '{1}',pid = {2},pic = '{3}',tel = '{4}',job = '{5}',memo = '{6}'
                                    where did='{7}'",
       txt_dname.Text,rtsex.SelectedValue,ddlpid.SelectedValue,addrpic,txt_tel.Text,ddljob.SelectedValue,txt_memo.Text,Session["aid"].ToString());
